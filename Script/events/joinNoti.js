...
module.exports.onLoad = function () {
    ...
    const path2 = join(__dirname, "cache", "", ");
...
${global.config.PREFIX}Help\n${global.config.PREFIX} 𝄟≛⃝cute baby𝄟≛⃝🧡

\n\n⋆✦⋆⎯⎯⎯⎯⎯⎯⎯⎯⎯⋆✦⋆
`, attachment: fs.createReadStream(__dirname + "/cache/MAMUN.mp4")} ,threadID));
    }
    else {
        try {
